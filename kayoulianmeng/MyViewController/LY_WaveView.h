...
@class LY_WaveView;
@protocol LY_WaveViewDelegate <NSObject>

@optional
//自定义背景渐变
- (void)drawBgGradient:(LY_WaveView*)waveView context:(CGContextRef)context;
@end

@interface LY_WaveView : UIView
...
@property (nonatomic, weak) id<LY_WaveViewDelegate>delegate;
