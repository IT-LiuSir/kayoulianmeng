...
- (void)changeViewType{
    ...
    if ([self.type isEqualToString:@"article"]) {
        //文章界面样式
        [self customArticleTypeView];
    }else if([self.type isEqualToString:@"video"]){
        //视频播放界面样式
        [self customVideoTypeView];
    }else if ([self.type isEqualToString:@"nearby"]){
        //附近界面详细界面
        [self customNearbyTypeView];
    }else{
        //WebView展示界面
        [self customWebTypeView];
    }

}

- (void)customArticleTypeView{
    
}

- (void)customVideoTypeView{
...
- (void)customNearbyTypeView{
    
}

- (void)customWebTypeView{
