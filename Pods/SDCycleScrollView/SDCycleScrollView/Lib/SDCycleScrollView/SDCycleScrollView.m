...
- (void)initialization
{
    ...
    _titleLabelTextFont= [UIFont systemFontOfSize:30];
    _titleLabelBackgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.5];
    _titleLabelHeight = 30;
    _titleLabelTextAlignment = NSTextAlignmentLeft;
    _mainTitleLabelTextColor = [UIColor whiteColor];
    _mainTitleLabelTextFont = [UIFont fontWithName:@"HeiTi SC" size:kFontSize(20)];
    _mainTitleLabelBackgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0];
    _mainTitleLabelHeight = kFontSize(40/1.5);
    _mainTitleLabelTextAlignment = NSTextAlignmentLeft;
    _subTitleLabelTextColor = [UIColor whiteColor];
    _subTitleLabelTextFont = [UIFont systemFontOfSize:kFontSize(20/1.5)];
    _subTitleLabelBackgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0];
    _subTitleLabelHeight = kFontSize(50/1.5);
    _subTitleLabelTextAlignment = NSTextAlignmentLeft;
    _autoScroll = YES;
    _infiniteLoop = YES;
...
- (void)setMainTitleGroup:(NSArray *)mainTitlesGroup{
    _mainTitlesGroup = mainTitlesGroup;
    if (self.onlyDisplayText) {
        NSMutableArray *temp = [NSMutableArray new];
        for (int i = 0; i < _mainTitlesGroup.count; i++) {
            [temp addObject:@""];
        }
        self.backgroundColor = [UIColor clearColor];
        self.imageURLStringsGroup = [temp copy];
...
- (void)setSubTitleGroup:(NSArray *)subTitlesGroup{
    _subTitlesGroup = subTitlesGroup;
    if (self.onlyDisplayText) {
        NSMutableArray *temp = [NSMutableArray new];
        for (int i = 0; i < _subTitlesGroup.count; i++) {
            [temp addObject:@""];
        }
        self.backgroundColor = [UIColor clearColor];
        self.imageURLStringsGroup = [temp copy];
...
- (void)layoutSubviews
{
    ...
    */
    ...
    if (self.pageControlAliment == SDCycleScrollViewPageContolAlimentRight) {
        x = self.mainView.sd_width - size.width - 10;   //对pageContro的x坐标进行设置
    }
    CGFloat y = self.mainView.sd_height - size.height - 5;     //对pageContro的y坐标进行设置
    ...
    CGRect pageControlFrame = CGRectMake(x, y, kFontSize(size.width/1.5) , kFontSize(size.height/1.5));
...
//    }
    ...
    if (_mainTitlesGroup.count && itemIndex < _mainTitlesGroup.count) {
        cell.mainTitle = _mainTitlesGroup[itemIndex];
        cell.subTitle = _subTitlesGroup[itemIndex];
    }
    
    if (!cell.hasConfigured) {
        cell.mainTitleLabelBackgroundColor = self.mainTitleLabelBackgroundColor;
        cell.mainTitleLabelHeight = self.mainTitleLabelHeight;
        cell.mainTitleLabelTextAlignment = self.mainTitleLabelTextAlignment;
        cell.mainTitleLabelTextColor = self.mainTitleLabelTextColor;
        cell.mainTitleLabelTextFont = self.mainTitleLabelTextFont;
