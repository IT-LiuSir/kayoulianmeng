...
/** 每张图片对应要显示的主标题文字数组*/
@property (nonatomic, strong) NSArray *mainTitlesGroup;
...
/** 轮播文字mainLabel字体颜色 */
@property (nonatomic, strong) UIColor *mainTitleLabelTextColor;

/** 轮播文字mainLabel字体大小 */
@property (nonatomic, strong) UIFont  *mainTitleLabelTextFont;

/** 轮播文字mainLabel背景颜色 */
@property (nonatomic, strong) UIColor *mainTitleLabelBackgroundColor;

/** 轮播文字mainLabel高度 */
@property (nonatomic, assign) CGFloat mainTitleLabelHeight;

/** 轮播文字mainLabel对齐方式 */
@property (nonatomic, assign) NSTextAlignment mainTitleLabelTextAlignment;
